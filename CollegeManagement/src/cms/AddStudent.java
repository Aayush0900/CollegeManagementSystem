...
class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("cms/icons/fourth.jpg"));
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"Computer Science","Electronics","Electrical","Mechanical","Civil","None"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        double ph = Double.parseDouble(ff);
