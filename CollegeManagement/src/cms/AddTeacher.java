...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("cms/icons/fifth.jpg"));
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        t11=new JTextField();
        t11.setText(currYear+"Emp"+first);
...
//        double ph = Double.parseDouble(f1);
//        double p1 = Double.valueOf(ff); 
        if(ae.getSource() == b){
            if(j.length()!=12){
                JOptionPane.showMessageDialog(null,"Enter Valid Aadhar Number");
            }
            else if(ff.length()!=10){
