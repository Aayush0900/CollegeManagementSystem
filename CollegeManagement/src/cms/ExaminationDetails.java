...
//        search.enableInputMethods(true);
...
//                setVisible(false);
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Result",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                while(rs.next()){
                    if(rs.getString("rollno").equals(search.getText())){
                        i=1;
                        break;
                    }
                }
