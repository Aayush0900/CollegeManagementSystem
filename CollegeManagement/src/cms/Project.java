...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("cms/icons/third.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon1.png"));
...
//        m1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon2.png"));
...
//        m2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon3.png"));
...
//        u1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon4.jpg"));
...
//        u2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon14.jpg"));
...
//        a1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon15.png"));
...
//        a2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon15.png"));
...
//        b1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon14.jpg"));
...
//        b2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon16.png"));
...
//        c1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon17.png"));
...
//        c2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon5.png"));
...
//        r1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon6.png"));
...
//        JMenuItem s2 = new JMenuItem("Student Fee Form");
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon7.png"));
...
//        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon8.png"));
...
//        s2.addActionListener(this);
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon9.png"));
...
//        ut1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon10.png"));
...
//        ut2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon11.png"));
...
//        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon13.jpg"));
...
//        aboutus.addActionListener(this);
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("cms/icons/icon12.png"));
