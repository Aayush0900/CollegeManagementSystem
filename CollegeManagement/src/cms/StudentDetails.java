...
//        add(sp);
        ...
        TableRowSorter<TableModel> rowSorter
            = new TableRowSorter<>(t1.getModel());
        
        setLayout(new BorderLayout());
        add(new JScrollPane(t1), BorderLayout.CENTER);
        t1.setRowSorter(rowSorter);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                ...
                String q1 = "delete from attendance_student where rollno = '"+a+"'";
                String q2 = "delete from marks where rollno = '"+a+"'";
                String q3 = "delete from subject where rollno = '"+a+"'";
