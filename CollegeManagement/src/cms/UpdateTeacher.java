...
//        int i=0;
        ...
        if(ae.getSource()==b){
            double ph = Double.parseDouble(t6.getText());
            String j = t10.getText();
            String ff = t6.getText();
            if(j.length()!=12){
                JOptionPane.showMessageDialog(null,"Enter Valid Aadhar Number");
            }
            else if(ff.length()!=10 || ph<6201010000.00){
            ...
            try{
                conn con = new conn();
                String str = "update teacher set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"', course = '"+t11.getText()+"',emp_id='"+t13.getText()+"',dept='"+t14.getText()+"' where emp_id='"+t12.getText()+"'";
...
//            new Project().setVisible(true);
        ...
        if(ae.getSource() == b2){
            try{
                ...
                while(rs.next()){
                    if(t12.getText().equals(rs.getString("emp_id"))){
                        i=1;
                        f.setVisible(true);
